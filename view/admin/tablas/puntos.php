...
// Consulta SQL para seleccionar los datos de la tabla puntos
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                    <h2   style="margin-bottom: 20px; color: #333;"><strong>Tabla de Puntos</strong></h2>
                    </div>
                </div>
                <hr />
                <!-- /. ROW  -->
                                        ...
                                        <tbody>
                                            ...
                                            if ($resultado->rowCount() > 0) {
                                                while ($fila = $resultado->fetch(PDO::FETCH_ASSOC)) {
                                                    echo "<tr>";
                                                    echo "<td>" . $fila['id_puntos'] . "</td>";
                                                    echo "<td>" . $fila['puntos'] . "</td>";
                                                    echo "<td>" . $fila['nivel'] . "</td>";
                                                    echo "<td>" . $fila['rango'] . "</td>";
                                                    echo "<td><img src='data:image/jpeg;base64," . base64_encode($fila['rango_img']) . "' width='100' height='100'></td>";
                                                    // Aquí puedes agregar cualquier acción adicional si lo necesitas
                                                    echo "<td><a href='../update/editar_puntos.php?id=" . $fila['id_puntos'] . "' class='btn btn-primary' onclick=\"window.open('../update/editar_puntos.php?id={$fila['id_puntos']}','','width=500,height=500,toolbar=NO'); return false;\">Editar</a></td>";
                                                    echo "</tr>";
                                                }
                                            } else {
                                                echo "<tr><td colspan='6'>No se encontraron puntos</td></tr>";
                                            }
                                            ?>
                                        </tbody>
                                    </table>

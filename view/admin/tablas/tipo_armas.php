...
// Consultar datos de la tabla tipo_arma
$sql = "SELECT * FROM tipo_arma";
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                    <h2   style="margin-bottom: 20px; color: #333;"><strong>Tabla de Roles</strong></h2>
                    </div>
                </div>
                <hr />
                <!-- /. ROW  -->
                <div class="row">
                    <div class="col-md-9 col-sm-12 col-xs-12">
                        ...
                        <div class="panel panel-default">
                            ...
                            <h4 style="margin-bottom: 20px; font-weight: bold; color: #333;"> <strong> Roles:</strong></h4>
                ...
                <tbody>
                    ...
                    if ($resultado->rowCount() > 0) {
                        while ($fila = $resultado->fetch(PDO::FETCH_ASSOC)) {
                            echo "<tr>";
                            echo "<td>{$fila['id_tipo_arma']}</td>";
                            echo "<td contenteditable='true'>{$fila['tipo_arma']}</td>";
                            echo "<td><a href='../update/editar_tipo.php?id=" . $fila['id_tipo_arma'] . "' class='btn btn-primary'  onclick=\"window.open('../update/editar_tipo.php?id={$fila['id_tipo_arma']}','','width=500,height=500,toolbar=NO'); return false;\">Editar</a></td>"; // Botón de editar con enlace a la página de edición
                            echo "</tr>";
                        }
                    } else {
                        echo "<tr><td colspan='3'>No se encontraron tipos de arma</td></tr>";
                    }
                    ?>
                </tbody>
            </table>

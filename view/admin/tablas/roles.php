                                        ...
                                        <tbody>
                                            ...
                                            if ($resultado->rowCount() > 0) {
                                                ...
                                                while ($fila = $resultado->fetch(PDO::FETCH_ASSOC)) {
                                                    ...
                                                    echo "<td>" . $fila['rol'] . "</td>";
                                                    echo "<td><a href='../update/editar_rol.php?id=" . $fila['id_rol'] . "' class='btn btn-primary'  onclick=\"window.open('../update/editar_rol.php?id={$fila['id_rol']}','','width=500,height=500,toolbar=NO'); return false;\">Editar</a></td>"; // Botón de editar con enlace a la página de edición
                                                    echo "</tr>";
                                                }
                                            } else {

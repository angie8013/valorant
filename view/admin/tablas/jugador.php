...
$sql = "SELECT jugador.*, rol.rol AS nombre_rol, estado.estado AS nombre_estado 
        FROM jugador 
        INNER JOIN rol ON jugador.id_rol = rol.id_rol 
        INNER JOIN estado ON jugador.id_estado = estado.id_estado";
...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                    <h2   style="margin-bottom: 20px; color: #333;"><strong>Tabla de Jugadores</strong></h2>
                    </div>
                </div>
                <hr />
                <!-- /. ROW  -->
    ...
    if ($resultado->rowCount() > 0) {
        while ($fila = $resultado->fetch(PDO::FETCH_ASSOC)) {
            ...
            echo "<td>" . $fila['username'] . "</td>";
            echo "<td>" . $fila['nombre_rol'] . "</td>"; // Mostrar el nombre del rol

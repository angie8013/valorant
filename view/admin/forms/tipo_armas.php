...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Insertar nuevo tipo de arma
    $insertTipoArmaSQL = $con->prepare("INSERT INTO tipo_arma (tipo_arma) VALUES (?)");
    if ($insertTipoArmaSQL->execute([$tipo_arma])) {
        $success_message = "Nuevo tipo de arma agregado exitosamente";
    } else {
        $error_message = "Error al agregar nuevo tipo de arma";
    }
}
?>
